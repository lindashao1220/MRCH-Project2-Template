...
{
    [CreateAssetMenu(fileName = "RetroLookProReadme", menuName = "Info/RetroLookProReadme", order = 1)]
    public class RetroLookProReadme : ScriptableObject
    {
